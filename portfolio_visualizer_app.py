...
Version avec Interface d'Allocation Améliorée + Performance Individuelle
"""
...
def download_data(tickers, start_date, end_date):
    """Télécharge les données de prix ajustés - VERSION ULTRA ROBUSTE"""
    try:
        # Convertit en string
        ...
        # Télécharge ticker par ticker pour éviter les problèmes de MultiIndex
...
with st.sidebar:
    ...
    # ========================================================================
    # 4. ALLOCATION AMÉLIORÉE avec input numérique et répartition égale
    # ========================================================================
    ...
    if abs(total_weight - 100) > 0.01:  # Tolérance de 0.01% pour les arrondis
